...
var SidebarProvider = React.forwardRef(function (_a, ref) {
    ...
    var setOpen = React.useCallback(function (value) {
        if (setOpenProp) {
            return setOpenProp === null || setOpenProp === void 0 ? void 0 : setOpenProp(typeof value === "function"
                ? value(open)
                : value);
        }
        _setOpen(value);
    ...
    return (React.createElement(SidebarContext.Provider, { value: contextValue },
        React.createElement(tooltip_1.TooltipProvider, { delayDuration: 0 },
            React.createElement("div", __assign({ style: __assign({ "--sidebar-width": SIDEBAR_WIDTH, "--sidebar-width-icon": SIDEBAR_WIDTH_ICON }, style), className: utils_1.cn("group/sidebar-wrapper flex min-h-svh w-full has-[[data-variant=inset]]:bg-sidebar", className), ref: ref }, props), children))));
});
...
var Sidebar = React.forwardRef(function (_a, ref) {
    ...
    if (collapsible === "none") {
        return (React.createElement("div", __assign({ className: utils_1.cn("flex h-full w-[--sidebar-width] flex-col bg-sidebar text-sidebar-foreground", className), ref: ref }, props), children));
    }
    if (isMobile) {
    ...
    return (React.createElement("div", { ref: ref, className: "relative group peer hidden md:block text-sidebar-foreground", "data-state": state, "data-collapsible": state === "collapsed" ? collapsible : "", "data-variant": variant, "data-side": side },
        React.createElement(notifications_1["default"], null),
        React.createElement("div", { className: utils_1.cn("duration-200 relative h-svh w-[--sidebar-width] bg-transparent transition-[width] ease-linear", "group-data-[collapsible=offcanvas]:w-0", "group-data-[side=right]:rotate-180", variant === "floating" ||
                variant === "inset"
                ? "group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)_+_theme(spacing.4))]"
                : "group-data-[collapsible=icon]:w-[--sidebar-width-icon]") }),
        React.createElement("div", __assign({ className: utils_1.cn("duration-200 fixed inset-y-0 z-10 hidden h-svh w-[--sidebar-width] transition-[left,right,width] ease-linear md:flex", side === "left"
...
var SidebarTrigger = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(button_1.Button, __assign({ ref: ref, "data-sidebar": "trigger", variant: "ghost", size: "icon", className: utils_1.cn("h-7 w-7", className), onClick: function (event) {
...
var SidebarRail = React.forwardRef(function (_a, ref) {
    ...
    var toggleSidebar = useSidebar().toggleSidebar;
    return (React.createElement("button", __assign({ ref: ref, "data-sidebar": "rail", "aria-label": "Toggle Sidebar", tabIndex: -1, onClick: toggleSidebar, title: "Toggle Sidebar", className: utils_1.cn("absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 transition-all ease-linear after:absolute after:inset-y-0 after:left-1/2 after:w-[2px] hover:after:bg-sidebar-border group-data-[side=left]:-right-4 group-data-[side=right]:left-0 sm:flex", "[[data-side=left]_&]:cursor-w-resize [[data-side=right]_&]:cursor-e-resize", "[[data-side=left][data-state=collapsed]_&]:cursor-e-resize [[data-side=right][data-state=collapsed]_&]:cursor-w-resize", "group-data-[collapsible=offcanvas]:translate-x-0 group-data-[collapsible=offcanvas]:after:left-full group-data-[collapsible=offcanvas]:hover:bg-sidebar", "[[data-side=left][data-collapsible=offcanvas]_&]:-right-2", "[[data-side=right][data-collapsible=offcanvas]_&]:-left-2", className) }, props)));
});
exports.SidebarRail = SidebarRail;
SidebarRail.displayName = "SidebarRail";
var SidebarInset = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React.createElement("main", __assign({ ref: ref, className: utils_1.cn("relative flex min-h-svh flex-1 flex-col bg-background", "peer-data-[variant=inset]:min-h-[calc(100svh-theme(spacing.4))] md:peer-data-[variant=inset]:m-2 md:peer-data-[state=collapsed]:peer-data-[variant=inset]:ml-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow", className) }, props)));
});
exports.SidebarInset = SidebarInset;
SidebarInset.displayName = "SidebarInset";
var SidebarInput = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React.createElement(input_1.Input, __assign({ ref: ref, "data-sidebar": "input", className: utils_1.cn("h-8 w-full bg-background shadow-none focus-visible:ring-2 focus-visible:ring-sidebar-ring", className) }, props)));
});
exports.SidebarInput = SidebarInput;
SidebarInput.displayName = "SidebarInput";
var SidebarHeader = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React.createElement("div", __assign({ ref: ref, "data-sidebar": "header", className: utils_1.cn("flex flex-col gap-2 p-2", className) }, props)));
});
exports.SidebarHeader = SidebarHeader;
SidebarHeader.displayName = "SidebarHeader";
var SidebarFooter = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React.createElement("div", __assign({ ref: ref, "data-sidebar": "footer", className: utils_1.cn("flex flex-col gap-2 p-2", className) }, props)));
});
exports.SidebarFooter = SidebarFooter;
SidebarFooter.displayName = "SidebarFooter";
var SidebarSeparator = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React.createElement(separator_1.Separator, __assign({ ref: ref, "data-sidebar": "separator", className: utils_1.cn("mx-2 w-auto bg-sidebar-border", className) }, props)));
});
exports.SidebarSeparator = SidebarSeparator;
SidebarSeparator.displayName = "SidebarSeparator";
var SidebarContent = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React.createElement("div", __assign({ ref: ref, "data-sidebar": "content", className: utils_1.cn("flex min-h-0 flex-1 flex-col gap-2 overflow-auto group-data-[collapsible=icon]:overflow-hidden", className) }, props)));
});
exports.SidebarContent = SidebarContent;
SidebarContent.displayName = "SidebarContent";
var SidebarGroup = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React.createElement("div", __assign({ ref: ref, "data-sidebar": "group", className: utils_1.cn("relative flex w-full min-w-0 flex-col p-2", className) }, props)));
});
...
var SidebarGroupLabel = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(Comp, __assign({ ref: ref, "data-sidebar": "group-label", className: utils_1.cn("duration-200 flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium text-sidebar-foreground/70 outline-none ring-sidebar-ring transition-[margin,opa] ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0", "group-data-[collapsible=icon]:-mt-8 group-data-[collapsible=icon]:opacity-0", className) }, props)));
});
...
var SidebarGroupContent = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React.createElement("div", __assign({ ref: ref, "data-sidebar": "group-content", className: utils_1.cn("w-full text-sm", className) }, props)));
});
...
var SidebarMenu = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React.createElement("ul", __assign({ ref: ref, "data-sidebar": "menu", className: utils_1.cn("flex w-full min-w-0 flex-col gap-1", className) }, props)));
});
exports.SidebarMenu = SidebarMenu;
SidebarMenu.displayName = "SidebarMenu";
var SidebarMenuItem = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React.createElement("li", __assign({ ref: ref, "data-sidebar": "menu-item", className: utils_1.cn("group/menu-item relative", className) }, props)));
});
exports.SidebarMenuItem = SidebarMenuItem;
SidebarMenuItem.displayName = "SidebarMenuItem";
var sidebarMenuButtonVariants = class_variance_authority_1.cva("peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-none ring-sidebar-ring transition-[width,height,padding] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:!size-8 group-data-[collapsible=icon]:!p-2 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0", {
    variants: {
        variant: {
...
var SidebarMenuButton = React.forwardRef(function (_a, ref) {
    ...
    var button = (React.createElement(Comp, __assign({ ref: ref, "data-sidebar": "menu-button", "data-size": size, "data-active": isActive, className: utils_1.cn(sidebarMenuButtonVariants({
            variant: variant,
            size: size
        }), className) }, props)));
    if (!tooltip) {
...
var SidebarMenuSkeleton = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement("div", __assign({ ref: ref, "data-sidebar": "menu-skeleton", className: utils_1.cn("rounded-md h-8 flex gap-2 px-2 items-center", className) }, props),
...
var SidebarMenuSub = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React.createElement("ul", __assign({ ref: ref, "data-sidebar": "menu-sub", className: utils_1.cn("mx-3.5 flex min-w-0 translate-x-px flex-col gap-1 border-l border-sidebar-border px-2.5 py-0.5", "group-data-[collapsible=icon]:hidden", className) }, props)));
});
