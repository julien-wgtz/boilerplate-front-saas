                ...
                React.createElement(sidebar_1.SidebarMenu, null, currentAccount ? (React.createElement(sidebar_1.SidebarMenuItem, null,
                    React.createElement(sidebar_1.SidebarMenuButton, { size: "lg", asChild: true },
                        React.createElement(dropdown_menu_1.DropdownMenu, null,
                            React.createElement(dropdown_menu_1.DropdownMenuTrigger, { asChild: true },
                                React.createElement(sidebar_1.SidebarMenuButton, { size: "lg", className: "data-[state=open]:bg-sidebar-accent data-[state=open]:text-sidebar-accent-foreground" },
                                    React.createElement("div", { className: "flex aspect-square size-8 items-center justify-center rounded-lg bg-sidebar-primary text-sidebar-primary-foreground" },
                                        React.createElement(lucide_react_1.Command, { className: "size-4" })),
                            ...
                            React.createElement(dropdown_menu_1.DropdownMenuContent, { className: "w-[15rem] ml-[0.5rem] min-w-56 rounded-lg", side: "bottom", align: "end", sideOffset: 4 }, accountValid === null || accountValid === void 0 ? void 0 : accountValid.map(function (item, index) { return (React.createElement("div", { key: "item-account-" + index },
                                React.createElement(dropdown_menu_1.DropdownMenuLabel, { className: "p-0 font-normal cursor-pointer", onClick: function () {
                                    ...
                                    React.createElement("div", { className: "flex items-center gap-2 p-2 " },
                                        React.createElement("div", { className: "flex aspect-square size-6 items-center justify-center rounded-lg bg-sidebar-primary text-sidebar-primary-foreground" },
                                            React.createElement(lucide_react_1.Command, { className: "size-3" })),
                                ...
                                index !==
                                    accountValid.length -
                                        1 && (React.createElement(separator_1.Separator, null)))); })))))) : (React.createElement(skeleton_1.Skeleton, { className: "h-12 w-full" })))),
            ...
            React.createElement(sidebar_1.SidebarFooter, null,
                ...
                React.createElement(sidebar_1.SidebarMenu, null, user ? (React.createElement(sidebar_1.SidebarMenuItem, null,
                    React.createElement(dropdown_menu_1.DropdownMenu, null,
                        React.createElement(dropdown_menu_1.DropdownMenuTrigger, { asChild: true },
                            React.createElement(sidebar_1.SidebarMenuButton, { size: "lg", className: "data-[state=open]:bg-sidebar-accent data-[state=open]:text-sidebar-accent-foreground" },
                                React.createElement(avatar_1.Avatar, { className: "h-8 w-8 rounded-lg" },
                                    React.createElement(avatar_1.AvatarImage, { src: "", alt: user.name }),
                                    React.createElement(avatar_1.AvatarFallback, { className: "rounded-lg" }, user.name[0].toUpperCase())),
                                React.createElement("div", { className: "grid flex-1 text-left text-sm leading-tight" },
